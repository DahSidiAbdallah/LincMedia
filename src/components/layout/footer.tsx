            ...
            <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-3 gap-8 text-muted-foreground">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3">
                        <button type="button" onClick={() => openExternal(undefined, 'https://www.instagram.com/lincchevie')} aria-label="Instagram" className="p-1">
                        ...
                        <button type="button" onClick={() => openExternal(undefined, 'https://www.linkedin.com/company/lincmedia/')} aria-label="LinkedIn" className="p-1">
                        ...
                        <button type="button" onClick={() => openExternal(undefined, 'https://www.youtube.com/@lincmedia495')} aria-label="YouTube" className="p-1">
                        ...
                        <button type="button" onClick={() => openExternal(undefined, 'https://x.com/lchevi3')} aria-label="X" className="p-1">
                        ...
                        <button type="button" onClick={() => openExternal(undefined, 'https://www.tumblr.com/lincchevie')} aria-label="Tumblr" className="p-1">
                        ...
                        <button type="button" onClick={() => openExternal(undefined, 'https://www.facebook.com/lincchevie')} aria-label="Facebook" className="p-1">
